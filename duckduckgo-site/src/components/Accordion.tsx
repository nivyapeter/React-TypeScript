...
//   return (
//   <div className="border-1 border-[#e5e5e5] pl-[50px]">
//     <div>
//         {data.map(data)=> {
//         return (
...
//         </button>
//         <h3 className="text-[21px] text-[#353748] font-semibold leading-6" onClick={() => setIsActive(!isActive)}>{data.question}</h3>
//     </div>
//     {isActive && <div className="pb-[25px] text-[#353748] text-base">
//         <p className="py-1">{data.answer}</p>
