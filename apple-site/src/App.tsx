...
function App() {
  return (
    <div className="App">
      ...
      <MacbookAirBlock  style={{  backgroundImage: `url(${whiteImg})`, height:"200px", }} title="MacBook Air" sub="Supercharged by M2"  text="Available in July" linkText="Learn more" buyText="View pricing"/>
